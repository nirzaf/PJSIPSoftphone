...
enum pjmedia_amr_options
{
    ...
    PJMEDIA_AMR_NO_GSMEFR   = 3,    /**< Disable gsm-efr mode.		*/
};
...
typedef pjmedia_codec_amr_config pjmedia_codec_gmsefr_config;
...
/**
 * Set GSM-EFR parameters.
 *
 * @param cfg	The settings;
 *
 * @return	PJ_SUCCESS on success.
 */
PJ_DECL(pj_status_t) pjmedia_codec_opencore_gmsefr_set_config(
                                        const pjmedia_codec_gmsefr_config* cfg);
