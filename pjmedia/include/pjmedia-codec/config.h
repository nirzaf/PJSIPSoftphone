...
/**
 * Enable Intel IPP GSM-EFR wideband codec. The PJMEDIA_HAS_INTEL_IPP_CODEC_GSMEFR
 * option must also be enabled to use this codec. This option is only used 
 * when PJMEDIA_HAS_INTEL_IPP is enabled.
 *
 * Default: 1
 */
#ifndef PJMEDIA_HAS_INTEL_IPP_CODEC_GSMEFR
#   define PJMEDIA_HAS_INTEL_IPP_CODEC_GSMEFR	1
#endif
...
/**
 * Enable OpenCORE GSM-EFR codec.
 *
 * Default: 0
 */
#ifndef PJMEDIA_HAS_OPENCORE_GSMEFR_CODEC
#   define PJMEDIA_HAS_OPENCORE_GSMEFR_CODEC	0
#endif
