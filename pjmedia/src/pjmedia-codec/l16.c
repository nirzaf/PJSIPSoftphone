 ...
 */
#define GET_PTIME(clock_rate, channel_cnt)	((pj_uint16_t)(clock_rate > 35000 ? 10/channel_cnt : 20))
				     ...
				     pjmedia_codec_param *attr )
{
     ...
     * sampling rate > 35 KHz
     */
	attr->info.frm_ptime = GET_PTIME(id->clock_rate, id->channel_cnt);
				    ...
				    pjmedia_codec **p_codec)
{
    ...
    /* Init private data */
    ptime = GET_PTIME(id->clock_rate, id->channel_cnt);
