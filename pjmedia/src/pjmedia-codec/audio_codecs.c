                                    ...
                                    const pjmedia_audio_codec_config *c)
{
...
#if PJMEDIA_HAS_OPENCORE_AMRNB_CODEC || PJMEDIA_HAS_OPENCORE_AMRWB_CODEC || PJMEDIA_HAS_OPENCORE_GSMEFR_CODEC
	...
	pjsip_opus_sdp_rewriter_init(PJMEDIA_OUR_OPUS_CODEC_SAMPLE_RATE);
#endif  /* PJMEDIA_HAS_OUR_OPUS_CODEC */
