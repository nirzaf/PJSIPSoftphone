...
public:
	...
	CIconButton m_ButtonMenu;
	SettingsDlg* settingsDlg;
	bool shortcutsEnabled;
	bool shortcutsBottom;
	ShortcutsDlg* shortcutsDlg;
	bool provisioningTimer;
	static DWORD WINAPI ProvisioningThread(LPVOID lpParam);
	LRESULT onProvisioning(WPARAM wParam, LPARAM lParam);
	void OnTimerProvisioning();
